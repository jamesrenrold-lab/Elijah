...
**Updating from an earlier release:** remove the old Elijah JAR and install 0.3.17 on the client and server. Do not keep two Elijah versions installed. Existing pouch contents are preserved.

## Install

1. Download the `Elijah-Pirate-1.20.1` artifact from the latest successful GitHub Actions build and unzip it.
2. Put `elijah-pirate-0.3.17.jar` in your Minecraft instance's `mods` folder.
